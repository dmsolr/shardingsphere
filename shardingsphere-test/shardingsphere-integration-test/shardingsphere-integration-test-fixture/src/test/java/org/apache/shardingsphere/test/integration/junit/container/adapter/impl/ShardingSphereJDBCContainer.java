...
public final class ShardingSphereJDBCContainer extends ShardingSphereAdapterContainer {
    ...
    private Optional<ZookeeperContainer> governance;
    ...
    public void start() {
        ...
        dataSourceMap = storageContainer.getDataSourceMap();
        isHealthy.set(true);
        System.out.println(">>>>>>>>>>>>>>>");
    }
    ...
    public DataSource getDataSource() {
        try {
            System.out.println(EnvironmentPath.getRulesConfigurationFile(getParameterizedArray().getScenario()));
